...
glob.sync(path.join(__dirname, 'fixtures/probuilds/responses/*')).forEach(fixture => {
...
glob.sync(path.join(__dirname, 'fixtures/probuilds/results/*.json')).forEach(fixture => {
