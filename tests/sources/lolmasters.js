...
glob.sync(path.join(__dirname, 'fixtures/lolmasters/responses/*')).forEach(fixture => {
...
glob.sync(path.join(__dirname, 'fixtures/lolmasters/results/*.json')).forEach(fixture => {
